...
<body>
  ...
  <center><h1>Lista de prestamos de libros</h1></center>
  <br>
    <div class="container mt-4">
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create">
        ...
        <table class="table table-bordered table-striped table-info">
            <thead>
              <tr>
                <th scope="col">Código del préstamo</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$prestamo->id_ususario}}</td>
                <td>{{$prestamo->fecha_salida}}</td>
                <td>{{$prestamo->fecha_devolucion}}</td>
                <td>
                  <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#edit{{$prestamo->id_prestamo}}">
                    Editar
                  </button>
                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{$prestamo->id_prestamo}}">
                    eliminar
                  </button>
                </td>
              </tr>
              @include('prestamos.model-info-pre')
              @endforeach
            </tbody>
          </table>
    </div>
    @include('prestamos.modal-create-pre')
    <br>
    <br>
    <footer>
      <div>
